...
const Info = () => {
  ...
  return (
    <div>
      <div className='w-[100%] py-[100px] mt-6 flex flex-col items-center justify-center lg:flex-row lg:mt-0 lg:items-center lg:justify-evenly'>
        {infoContent.map((items, index) => {
          return (

              <div className='h-[120px] mt-6 relative hover:scale-110 transition-all duration-[.5s]'>
